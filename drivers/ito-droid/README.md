...
a `LocalRobotAdapter` inside Ito. The current lightweight driver lifecycle can
also attach to an external Ito application with `ITO_URL`; completing its real
camera WebRTC publisher remains tracked in `docs/todo.md`.
