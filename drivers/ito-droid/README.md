...
The software stack below predates the current direct-WebRTC architecture. Treat
it as an exploration of the robot-side components that a future Ito driver may
adapt, not as the required Ito integration.
