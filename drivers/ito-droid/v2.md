...
Ito Droid Two is a physical robot concept for Ito, immersive teleoperation
...
It is a small humanoid robot inspired by the
[Zeroth Bot (Z-Bot) by K-Scale Labs](https://kscalelabs.com/). It uses
high-torque smart bus servos throughout, making it suitable for a walking
